...
const Navbar = () => {
  ...
  return (
    <nav className="navbar flex items-center justify-center bg-red-400 absolute bottom-0 left-0 w-full h-[80px] bg-white shadow-md">
      <ul className="flex flex-row justify-center items-center gap-3">
        <li className="h-12 w-12 flex items-center justify-center rounded-full bg-blue">
