  ...
  return (
    <div className="bg-background h-full">
      ...
      <div className="p-6 flex flex-col items-center justify-center -translate-y-[5%] h-full">
        ...
        <h1 className="text-2xl font-digitalSansMediumItalic mt-4 mb-8"><span className="uppercase mr-2">{utilisateur?.nom}</span>{utilisateur?.prenom}</h1>
        ...
        <div className="mt-4 bg-white w-full rounded-md p-6 flex flex-col gap-2.5">
          <p className="flex flex-row justify-between">Nom Prénom <span className="font-digitalSansMediumItalic">{utilisateur?.nom} {utilisateur?.prenom}</span></p>
          <p className="flex flex-row justify-between">Email <span className="font-digitalSansMediumItalic">{utilisateur?.email}</span></p>
        </div>
